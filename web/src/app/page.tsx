          ...
          <div className="mt-4 space-y-3">
            ...
            <div className="rounded-2xl border border-black/10 bg-white/40 p-4">
              ...
              <div className="mt-2 flex flex-wrap gap-2 text-[11px] text-slate-600">
                <span className="rounded-full border border-black/10 bg-white/50 px-2 py-1">
                  style
                </span>
                <span className="rounded-full border border-black/10 bg-white/50 px-2 py-1">
                  formatting
  ...
  return (
    <main className="relative z-10 min-h-screen text-[#0b0f14]">
      ...
      <section className="relative isolate">
        {/* pb-40 so the bottom floater never overlaps content */}
        <div className="mx-auto w-full max-w-6xl px-5 pb-40 pt-14">
          {/* ===== HERO (unified glass) ===== */}
            ...
            <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:items-center">
              ...
              <div>
                ...
                <p className={`mt-4 max-w-xl text-pretty text-base leading-relaxed ${textBody}`}>
                  DocAgent helps product teams turn PRDs into customer-facing documentation
                  that stays accurate as the product evolves.
                </p>

                <p className={`mt-3 max-w-xl text-pretty text-base leading-relaxed ${textBody}`}>
                  It takes how a feature was designed internally and converts it into
                  explanations customers can actually use — without leaking internal context.
                </p>

                {/* ✅ Removed hero buttons (now in floating bar) */}
              </div>
                ...
                <div className="p-5 grid grid-cols-12 gap-4">
                  ...
                  <article className="col-span-7 rounded-2xl bg-[#0b0f14]/85 p-4 text-white">
                    ...
                    <p className="mt-2 text-sm text-white/70">
                      This help content was generated directly from the product’s PRD
                      and structured for end users.
                    </p>
                  </article>
                </div>
              </div>
      ...
      {/* ✅ Floating CTA bar (bottom-center, stays on scroll) */}
      <div className="fixed inset-x-0 bottom-5 z-50 flex justify-center px-4">
        <div className="flex items-center gap-2 rounded-2xl border border-black/10 bg-white/40 backdrop-blur-2xl shadow-[0_16px_50px_rgba(0,0,0,0.10)] px-3 py-3">
